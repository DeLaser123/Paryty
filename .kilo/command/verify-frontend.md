---
description: Run full frontend verification pipeline — TypeScript check, build, test, lint
agent: frontend-engineer
---
# Verify Frontend — Paryty Frontend Verification Pipeline

Run the full frontend verification pipeline for Paryty. After every TypeScript/React change, all gates must pass.
...
## Exit Protocol
- ALL gates pass: Report "Frontend verification passed" with raw output
